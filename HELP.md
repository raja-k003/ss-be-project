...
* The original package name 'com.example.ss-be-project' is invalid and this project uses 'com.example.ssbeproject' instead.
...
* [Spring Reactive Web](https://docs.spring.io/spring-boot/docs/2.7.0-SNAPSHOT/reference/htmlsingle/#web.reactive)
